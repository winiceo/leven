...
(((root, factory) => {
  ...
  if (typeof define === 'function' && define.amd) {
    define(['moment', 'jquery', 'exports'], (momentjs, $, exports) => {
  ...
  // Finally, as a browser global.
...
})(this, (root, daterangepicker, moment, $) => {
    ...
    DateRangePicker.prototype = {
        ...
        setOptions: function(options, callback) {
            ...
            if (typeof options.startDate === 'undefined' && typeof options.endDate === 'undefined') {
                if ($(this.element).is('input[type=text]')) {
                    const val = $(this.element).val(), split = val.split(this.separator);
            ...
            if (this.opens == 'right' || this.opens == 'center') {
                ...
                const first = this.container.find('.calendar.first');
                const second = this.container.find('.calendar.second');
            ...
            $.each(this.buttonClasses, (idx, val) => {
        ...
        move: function () {
            let parentOffset = { top: 0, left: 0 }, containerTop;
        ...
        inputsChanged: function (e) {
            const el = $(e.target);
            const date = moment(el.val(), this.format);
        ...
        updateMonthYear: function (e) {
            const isLeft = $(e.target).closest('.calendar').hasClass('left'), leftOrRight = isLeft ? 'left' : 'right', cal = this.container.find('.calendar.'+leftOrRight);
        ...
        updateTime: function(e) {
            ...
            const cal = $(e.target).closest('.calendar'), isLeft = cal.hasClass('left');
        ...
        buildCalendar: function (month, year, hour, minute, second, side) {
            ...
            let curDate = moment([lastYear, lastMonth, startDay, 12, minute, second]).utcOffset(this.timeZone);
