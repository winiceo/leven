tinymce.PluginManager.add("insertdatetime", function (a) {
  function b(b, c) {
    ...
    var d = b(c);if (a.settings.insertdatetime_element) {
      var e;e = b(/%[HMSIp]/.test(c) ? "%Y-%m-%dT%H:%M" : "%Y-%m-%d"), d = '<time datetime="' + e + '">' + d + "</time>";var f = a.dom.getParent(a.selection.getStart(), "time");if (f) return void a.dom.setOuterHTML(f, d);
    }a.insertContent(d);
  }var d,
      e,
      ...
      j = [];a.addCommand("mceInsertDate", function () {
