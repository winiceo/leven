$(() => {
    ...
    const graph3 = new Rickshaw.Graph({
    ...
    const graph4 = new Rickshaw.Graph({
    ...
    const graph5 = new Rickshaw.Graph({
    ...
    const graph6 = new Rickshaw.Graph({
    ...
    const graph7 = new Rickshaw.Graph({
        element: document.querySelector("#rickshaw_scatterplot"),
        renderer: 'scatterplot',
        stroke: true,
        padding: { top: 0.05, left: 0.05, right: 0.05 },
        series: [{
            data: [{ x: 0, y: 15 }, { x: 1, y: 18 }, { x: 2, y: 10 }, { x: 3, y: 12 }, { x: 4, y: 15 }, { x: 5, y: 24 }, { x: 6, y: 28 }, { x: 7, y: 31 }, { x: 8, y: 22 }, { x: 9, y: 18 }, { x: 10, y: 16 }],
            color: '#1ab394'
        }]
    });
    graph7.render();
});
//# sourceMappingURL=rickshaw-demo.js.map
