module.exports = {
    kevio: {
        ...
        auth: {
            token: {
                secret: "NRf76W4i/wdVP98s+0uz5Aa9WP11WOKZbS3wsHT184ZhNhwGerZjkzQgE2oVB/WSMNIhzV3IT7+3acF1CLrrMQ=="
            },
            local: {}
        }
    },
    ...
    social: {
        'myapp': {
            facebook: {
                ...
                key: 'api key',
                secret: 'api secret',
                callback: "http://localhost/api/myapp/facebook/callback",
                success: "/success-url",
                failure: "/failure-url"
            },
            twitter: {
                ...
                key: 'api key',
                secret: 'api secret',
                callback: 'http://localhost/api/myapp/twitter/callback',
                success: '/success-url',
                failure: '/failure-url'
            },
            instagram: {
                ...
                key: 'api key',
                secret: 'api secret',
                callback: 'http://localhost/api/myapp/instagram/callback',
                success: '/success-url',
                failure: '/failure-url'
            },
            foursquare: {
                ...
                key: "api key",
                secret: "api secret",
                callback: "http://localhost/api/myapp/foursquare/callback",
                success: '/success-url',
                failure: '/failure-url'
            }
        }
